...
public class ContaBean {
	...
	//O return null é utilizado aqui para forçar a aplicação a rodar o metodo getLista
	//Atualizando assim a lista após alguma alteração
	//Se esse retorno não fosse declarado assim a lista não sofreria alteração na view
